...
open class LBXScanWrapper: NSObject,AVCaptureMetadataOutputObjectsDelegate {
    ...
    static public func createCode( codeType:String, codeString:String, size:CGSize,qrColor:UIColor,bkColor:UIColor )->UIImage?
    {
        ...
        let colorFilter = CIFilter.init(name: "CIFalseColor", parameters: ["inputImage":qrFilter!.outputImage!,"inputColor0":CIColor(cgColor: qrColor.cgColor),"inputColor1":CIColor(cgColor: bkColor.cgColor)])
    ...
    static public func createCode128(  codeString:String, size:CGSize,qrColor:UIColor,bkColor:UIColor )->UIImage?
    {
        ...
        let qrFilter = CIFilter(name: "CICode39BarcodeGenerator")
        ...
        //UIImage(cgImage: cgImage!, scale: 1.0, orientation: UIImage.Orientation.up)
