   ...
   public  var isNeedCodeImage = false
    ...
    @objc open func startScan()
    {
        ...
        if (scanObj == nil)
        {
            ...
            {
                arrayCodeType = [AVMetadataObject.ObjectType.qr as NSString ,AVMetadataObject.ObjectType.ean13 as NSString ,AVMetadataObject.ObjectType.code39,AVMetadataObject.ObjectType.code128 as NSString] as? [AVMetadataObject.ObjectType]
            }
